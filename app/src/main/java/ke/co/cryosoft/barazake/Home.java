...
public class Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        issues = Issue.createIssuesList(20);
        IssuesAdapter adapter = new IssuesAdapter(this, issues);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Home.this, AddIssue.class);
                startActivity(i);
            }
        });
        ...
        TextView name = (TextView) navHeaderView.findViewById(R.id.UserName);
        TextView phone = (TextView) navHeaderView.findViewById(R.id.UserPhone);
